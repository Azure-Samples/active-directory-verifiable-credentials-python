...
#> 
    ...
    Write-Host "Creating the AAD application (Verifiable Credentials Python sample)"
    $clientAadApplication = New-AzADApplication -DisplayName "Verifiable Credentials Python sample" `
                                                -IdentifierUris "https://$tenantDomainName/vcpythonsample" 
    ...
    Write-Host "Done creating the client application (VC Python sample)"
    ...
    Add-Content -Value "<tr><td>client</td><td>$($clientAadApplication.AppId)</td><td><a href='$clientPortalUrl'>VC Python sample</a></td></tr>" -Path createdApps.html

    # Update config file for 'client'
    $configFile = $pwd.Path + "\..\config.json"
    Write-Host "Updating the sample code ($configFile)"
    $dictionary = @{ "<YOUR-AAD-TENANDID>" = $tenantId;"<YOUR-AAD-CLIENTID-FOR-KEYVAULT-ACCESS>" = $clientAadApplication.AppId;"<YOUR-AAD-CLIENTSECRET-FOR-KEYVAULT-ACCESS>" = $appCreds.SecretText };
